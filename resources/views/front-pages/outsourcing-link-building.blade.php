...
<head>
   ...
   <title>Outsourcing Link Building - Reachomation</title>
</head>
         ...
         <div class="container p-5">
            <div class="row">
               <div class="col-lg-10 offset-lg-1">
                  <h1 class="fw-bold mt-2" style="color: yellow;">TOP-TIER GUESTS POSTS</h1>
      ...
      <div class="container py-5">
         <div class="row">
            <div class="col-sm-7">
               ...
               <p class="mt-4" style="padding: 10px 0 10px;font-size: 20px;line-height: 30px;">With our Guest Post
                  services, you will see guaranteed increase in rankings and also increase in traffic. Let’s have a
                  conversation and get started.</p>
               <a href="{{ url('pricing') }}" class="btn btn-outline-success btn-lg mt-4"
                  style="padding: 0.5rem 2.8rem;padding-top:8px;font-weight:600;">Get Started <i
                     class="bi bi-chevron-double-right"></i></a>
            </div>
            <div class="col-sm-5">
                     ...
                     <div class="col">
                        <div class="card h-100 text-center shadow">
                           <div class="card-body p-2">
                              ...
                              <p class="card-text fw-bold text-muted mt-3 mb-2"><small><span
                                       class="fw-bold text-dark">1M+</span> Blogs &amp; Websites to choose from</small>
                              </p>
                           </div>
                        </div>
                     </div>
                     <div class="col">
                        <div class="card h-100 text-center shadow">
                           <div class="card-body p-2">
                              ...
                              <p class="card-text fw-bold text-muted mt-3 mb-2"><small>Site data metrics <span
                                       class="fw-bold text-dark">updated regularly</span></small></p>
                           </div>
                        </div>
                     </div>
                     <div class="col">
                        <div class="card h-100 text-center shadow">
                           <div class="card-body p-2">
                              ...
                              <p class="card-text fw-bold text-muted mt-3 mb-2"><small>Strong <span
                                       class="fw-bold text-dark">Domain Authority </span>and <span
                                       class="fw-bold text-dark">Trust Flow</span></small></p>
                           </div>
                        </div>
                     </div>
                     <div class="col">
                        <div class="card h-100 text-center shadow">
                           <div class="card-body p-2">
                              ...
                              <p class="card-text fw-bold text-muted mt-3 mb-2"><small>As per <span
                                       class="fw-bold text-dark">SEMRush </span>, G. Analytics and <span
                                       class="fw-bold text-dark">Alexa Rank</span></small></p>
                           </div>
                        </div>
                     </div>
                  </div>
