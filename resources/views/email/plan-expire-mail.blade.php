<?php  
  $plan = App\Models\SubscriptionPlan::where('id',$content['plan_id'])->first();
  $userInfo = App\Models\User::where('id',$content['user_id'])->first();
?>
                                                  ...
                                                  <td style="overflow-wrap:break-word;word-break:break-word;padding:33px 55px;font-family:'Cabin',sans-serif;"
                                                      ...
                                                      <div style="line-height: 160%; text-align: center; word-wrap: break-word;">
                                                          <p style="font-size: 14px; line-height: 160%;">
                                                              <span style="font-size: 22px; line-height: 35.2px;">Hi {{ ucfirst($userInfo['name']) }}, </span>
                                                          </p>
                                                          <p style="font-size: 14px; line-height: 160%;">
                                                              <span style="font-size: 18px; line-height: 28.8px;">
                                                                  Your Plan {{ ucfirst($plan['name']) }} has been expired 
                                                          ...
                                                          <p style="font-size: 10px; line-height: 160%;">
                                                              <span style="font-size: 18px; line-height: 28.8px;">
                                                                 Your plan detail is given below</strong>
                                                              </span>
                                                          </p>
                                                           <br>
                                                  ...
                                                  <tbody>
                                                      <tr>
                                                          <td style="overflow-wrap:break-word;word-break:break-word;font-family:'Cabin',sans-serif;"
                                                              align="left">
                                                              <span style="font-size: 18px; line-height: 28.8px;">Plan Name: {{ ucfirst($plan['name']) }}</span>
                                                          </td>
                                                      </tr>
                                                      <tr>
                                                          <td style="overflow-wrap:break-word;word-break:break-word;font-family:'Cabin',sans-serif;"
                                                              align="left">
                                                              <span style="font-size: 18px; line-height: 28.8px;">Plan Start Date: {{ $content['start_date'] }}</span>
                                                          </td>
                                                      </tr>
                                                       <tr>
                                                          <td style="overflow-wrap:break-word;word-break:break-word;font-family:'Cabin',sans-serif;"
                                                              align="left">
                                                              <span style="font-size: 18px; line-height: 28.8px;">Plan End Date: {{ $content['end_date'] }}</span>
                                                          </td>
                                                      </tr>
