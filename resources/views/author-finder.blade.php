      ...
      <div class="card-body d-flex align-items-center py-5">
         <div class="d-flex flex-column mx-auto">
            <div class="text-center">
               <h2 class="fw-bold display-6 mb-3">Find author name of blogs instantly</h2>
               <h5 class="mb-3">Upload list of blogs and our Author finder will find one of the authors of their blog posts</h5>
            </div>
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/js/<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-ka7Sk0Gln4gmtz2MlQnikT1wXgYsOg+OMhuP+IlRH9sENBO0LRn5q+8nbTov4+1p" crossorigin="anonymous"></script>" integrity="sha384-ka7Sk0Gln4gmtz2MlQnikT1wXgYsOg+OMhuP+IlRH9sENBO0LRn5q+8nbTov4+1p" crossorigin="anonymous">  </script>
<script>
