                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-8 col-lg-8 d-md-block custom-sidebar collapse bg-blue">
                            ...
                            <img src="{{ asset('images/elements/login.svg') }}"
                                 class="img-fluid position-absolute bottom-0 start-0" alt="Reachomation" width="460">
                        </div>
                            ...
                            <div class="card rounded-0 border-0">
                                <div class="card-body text-center">
                                    ...
                                    <div class="d-grid mt-4 mb-4">
                                        <a type="button" class="btn btn-outline-dark rounded-pill shadow-none"
                                           href="{{ url('/google') }}">
                                    ...
                                    <div class="border-3 border-top position-relative mb-4">
                                        <p class="mb-0 fw-bold position-absolute top-0 start-50 translate-middle bg-white px-3">OR
                                        </p>
                                    </div>
                                    ...
                                    <form method="POST" action="{{ route('login') }}" class="mt-4">
                                        ...
                                        <div class="d-flex mb-3">
                                            ...
                                            <div class="ms-auto">
                                                <a class="text-dark" href="{{ url('forgot-password') }}">
                                                    Forgot Password
                                                </a>
                                            </div>
                                        </div>
                                        <div class="mb-4">
                                            <div class="d-grid">
                                                <button type="submit" name="action" class="btn btn-green rounded-pill shadow-none">
                                                    Sign in
                                                </button>
                                            </div>
                                        </div>
