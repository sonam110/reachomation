      ...
      <div class="card-body d-flex align-items-center py-5">
         <div class="d-flex flex-column mx-auto">
            <div class="text-center">
               <h2 class="fw-bold display-6 mb-3">Validate your email list Instantly</h2>
               <h5 class="mb-3">Upload list of emails and our Email validator will validate the email list for you.</h5>
            </div>
