                                                            ...
                                                            <div style="color: #e5eaf5; line-height: 140%; text-align: center; word-wrap: break-word;">
                                                                <p style="font-size: 14px; line-height: 140%;">
                                                                    <span style="font-size: 28px; line-height: 39.2px;">
                                                                        <strong>
                                                                          Data Processing and Validation  has been completed
                                                                        </strong>
                                                                    </span>
                                                                </p>
                                                            </div>
                                                            ...
                                                            <div style="line-height: 160%; text-align: center; word-wrap: break-word;">
                                                                ...
                                                                <p style="font-size: 14px; line-height: 160%;">
                                                                    <span style="font-size: 18px; line-height: 28.8px;">
                                                                       We're happy to say that the data processing and validation on {{ ucfirst($content['camp_name']) }}  is now complete, your campaign has been scheduled and will be starting at time
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td style="overflow-wrap:break-word;word-break:break-word;font-family:'Cabin',sans-serif;"
                                                                    align="left">
                                                                    <span style="font-size: 18px; line-height: 28.8px;">Campaign Name: {{ ucfirst($content['camp_name']) }}</span>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td style="overflow-wrap:break-word;word-break:break-word;font-family:'Cabin',sans-serif;"
                                                                    align="left">
                                                                    <span style="font-size: 18px; line-height: 28.8px;">Total Email: {{ $content['total_email'] }}</span>
                                                                </td>
                                                            </tr>
                                                            ...
                                                            <td style="text-align: center;">
                                                                    <a download  href="{{ $content['csvfile'] }}" target="_blank"
                                                                    style=" 
                                                                    color: blue;
