                                                            ...
                                                            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                                                <tr>
                                                                    <td style="padding-right: 0px;padding-left: 0px;" align="center">
                                                                        ...
                                                                        <img align="center" border="0" src="{{asset('images/reachomation_logo_black.png')}}" alt="Image" title="Image"
                                                            ...
                                                            <div
                                                                ...
                                                                <p style="font-size: 14px; line-height: 140%;"><span
                                                                        style="font-size: 28px; line-height: 39.2px;"><strong><span
                                                                                style="line-height: 39.2px; font-size: 28px;">Plan Activate Successfully
                                                                            </span></strong>
                                                                    </span>
                                                                </p>
                                                            </div>
                                                    ...
                                                    <tr>
                                                        <td
                                                            ...
                                                            <div style="line-height: 160%; text-align: center; word-wrap: break-word;">
                                                                ...
                                                                <p style="font-size: 14px; line-height: 160%;"><span
                                                                        style="font-size: 18px; line-height: 28.8px;">Your plan {{ ucfirst($content['plan_name']) }} has been
                                                                        successfully activate.Find the attachment below </span></p>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                </tbody>
