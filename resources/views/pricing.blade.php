...
<head>
   ...
   <link rel="stylesheet" href="{{asset('css/style.css')}}">
      <link rel="stylesheet" href="{{asset('css/views/front-pages/pricing.css')}}">
...
<body>
   ...
   <main id="main">
               ...
               <div class="row monthlyPriceList animated">
                  <div class="col-md-4 d-none">
                     <div class="inner holder">
                        ...
                        <div class="price mt-2">
                           <p class="mb-0"><b>$0</b><span> / mo</span></p>
                        </div>
                        <div class="mb-4">
                        ...
                        <div class="info">
                           <p>Parallel user - 1</p>
                           <p>List size limit - 50</p>
                           <p>Monthly credits - 250</p>
                           <p>Email accounts <i class="bi bi-info-circle-fill text-primary" role="button" tabindex="0"
                              ...
                              - 1</p>
                           <p>'Import sites' feature - No</p>
                           <p>Skype & chat support - No</p>
                           <p>Personalized Outreach templates - 30+</p>
                           <p>Geo-location and TLD filters - Yes</p>
                           <p>Site traffic history - Yes</p>
                           <p>Performance Reporting - Yes</p>
                           <p>Website metrics - SEMRush Data</p>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="col-md-4 d-none">
                     <div class="inner holder active">
                        ...
                        <div class="price mt-2">
                           <p class="mb-0"><b id="starter-price">$99</b><span> / mo</span></p>
                        </div>
                        <div class="mb-4">
                           <button class="btn btn-light shadow-none rounded-pill px-5">
                              Subscribe <i class="bi bi-chevron-double-right"></i>
                           </button>
                        </div>
                        <div class="info">
                           <p>Parallel users - 2</p>
                           <p>List size limit - 1000</p>
                           <p>Monthly credits - 35000</p>
                           <p>Email accounts <i class="bi bi-info-circle-fill" role="button" tabindex="0"
                                 data-bs-toggle="tooltip"
                                 data-bs-title="This describes the number of email accounts you can connect for outreach automation"></i>
                              - 4</p>
                           <p>'Import sites' feature - Yes</p>
                           <p>Skype & chat support - Yes</p>
                           <p>Personalized Outreach templates 30+</p>
                           <p>Geo-location and TLD filters - Yes</p>
                           <p>Site traffic history - Yes</p>
                           <p>Performance Reporting - Yes</p>
                  ...
                  <div class="col-md-4 d-none">
                     <div class="inner holder">
                        ...
                        <div class="price mt-2">
                           <p class="mb-0"><b id="premium-price">$199</b><span> / mo</span></p>
                        </div>
                        <div class="mb-4">
                           <button class="btn btn-green shadow-none rounded-pill px-5">
                              Subscribe <i class="bi bi-chevron-double-right"></i>
                        ...
                        <div class="info">
                           <p>Parallel users - Unlimited</p>
                           <p>List size limit - 5000</p>
                           <p>Monthly credits - 35000</p>
                           <p>Email accounts <i class="bi bi-info-circle-fill text-primary" role="button" tabindex="0"
                                 data-bs-toggle="tooltip"
                                 data-bs-title="This describes the number of email accounts you can connect for outreach automation"></i>
      ...
      <!-- Comparison start -->
    <!--   <section class="app__plan-comparison">
         <div class="container py-lg-5 py-3">
            <div class="row justify-content-center text-center mb-5">
               <div class="col-lg-8 aos-init aos-animate" data-aos="fade-up">
                  <h2 class="mb-3 fw-bold">FULL PRICING FEATURES LIST</h2>
                  ...
                  <div class="table-responsive">
                     <table class="table table-striped table-bordered">
                        ...
                        <tbody>
                           ...
                           <tr>
                              <th scope="row">
                                 Email accounts <i class="bi bi-info-circle-fill text-primary" role="button"
                           ...
                           <tr>
                              ...
                              <td>DA, TF, Social profiles, SEMrush data, Publishing Frequency</td>
                              <td>DA, TF, Social profiles, SEMrush data, Publishing Frequency</td>
                              <td>DA, TF, Social profiles, SEMrush data, Publishing Frequency</td>
                           </tr>
                        </tbody>
