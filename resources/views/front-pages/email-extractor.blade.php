      ...
      <div class="card-body d-flex align-items-center py-5">
         <div class="d-flex flex-column mx-auto">
            <div class="text-center">
               <h2 class="fw-bold display-6 mb-3">Extract emails from websites instantly</h2>
               <h5 class="mb-3">Upload list of sites and our Email extractor will find emails out of them</h5>
            </div>
            ...
            <div class="mx-auto">
               ...
               {{-- <span class="btn btn-green btn-lg px-5 shadow-sm fw-500 btn-file fs-5 fw-500">
