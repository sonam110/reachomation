...
<body>
<p>Hello {{ ucfirst(@$content['name']) }},</p>

<p>Your campaign {{ ucfirst(@$content['camp_name']) }} has been Paused due to reason below:</p>

<p>Reason: <strong>{{ ucfirst(@$content['reason']) }}</strong>. We request you to resume this campaign after a few hours.To know more or get immediate help, we request you to contact customer support at <a href="#">contact@reachomation.com</a></p>
                                                                    ...
                                                                    <span style="font-size: 28px; line-height: 39.2px;">
                                                                        <strong>
                                                                            <span style="line-height: 39.2px; font-size: 28px;">
                                                                               Campaign Paused, Action Required
                                                                            </span>
                                                                        </strong>
                                                                    </span>
                                                                </p>
                                                            ...
                                                            <div style="line-height: 160%; text-align: center; word-wrap: break-word;">
                                                                ...
                                                                <p style="font-size: 14px; line-height: 160%;">
                                                                    <span style="font-size: 18px; line-height: 28.8px;">
                                                                        Your  {{ $content['stage'] }} attempt {{ $content['attemp'] }}  campaign {{ ucfirst($content['camp_name']) }} has been Paused due to reason below:
                                                                ...
                                                                <p style="font-size: 10px; line-height: 160%;">
                                                                    <span style="font-size: 18px; line-height: 28.8px;">
                                                                       Reason  <strong>{{ ucfirst($content['reason']) }}  </strong>for this campaign. We request you to resume this campaign after a few hours.To know more or get immediate help, we request you to contact customer support at contact@reachomation.com
                                                                    </span>
                                                                </p>
                                                                 <br>
                                                                <p style="font-size: 10px; line-height: 160%;">
                                                                    <span style="font-size: 18px; line-height: 28.8px;">
                                                                     Please spare a moment and send us your valuable feedback to improve our automated follow-up feature!
