...
<head>
   ...
   <title>Blogger Outreach Services - Reachomation</title>
</head>
         ...
         <div class="container p-5">
            <div class="row">
               <div class="col-lg-10 offset-lg-1">
                  <h1 class="fw-bold mt-2 text-white">ACCESS <span style="color: yellow;">TOP-TIER 1M+</span></h1>
                  <h1 class="fw-bold mt-4" style="color: yellow;">PRE-OUTREACHED BLOGS</h1>
                  <h5 class="mt-5 mb-4 text-white px-4" style="font-weight: 500;">Save Time, Money And Efforts With Our Exclusive Platforms</h5>
               </div>
